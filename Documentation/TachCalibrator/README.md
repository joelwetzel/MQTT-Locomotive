This board is a tool for testing and calibrating a Lionel truck with the Hall Effect tachometer onboard.  Use the TachCalibrator firmware.  It will send data to MQTT.
